...
public class CurrentTimePanel extends Panel implements Runnable {
	...
	public CurrentTimePanel(ClockSetting clockSetting) {
		this.clockSetting = clockSetting;
		this.fontSize = clockSetting.getFontSize();
		this.font = new Font(clockSetting.getFont(), Font.BOLD, fontSize);
		this.fontColor = convertToColor(clockSetting.getFontColor());
		this.backgroundColor = convertToColor(clockSetting.getBackgroudColor());
		setFontType();
		start();
	}
